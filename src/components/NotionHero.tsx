...
const NotionHero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Center Interaction Hint - Zoom-safe positioning */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 1.5 }}
        className="absolute top-1/2 left-1/3 transform -translate-x-1/2 -translate-y-1/2 z-20 pointer-events-none hidden lg:block"
        style={{ 
