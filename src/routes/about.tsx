  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About - Harneet Bali" },
      {
        ...
        content: "Builder at the intersection of product, AI systems, and healthcare workflows.",
      },
    ],
  }),
  component: AboutPage,
  ...
  return (
    <article className="flex flex-col gap-8">
      ...
      <section className="grid gap-8 lg:grid-cols-[1fr_280px]">
        <div className="flex flex-col gap-5 border-y border-border-hair py-6">
          <p className="max-w-[62ch] text-[15px] leading-[1.7] text-text-secondary">
            I build AI products where the hard part is not the demo - it is trust, adoption,
            measurement, and operational fit. My focus is healthcare AI, agentic systems, and the
            evaluation infrastructure that keeps them honest in production.
          </p>
          <p className="max-w-[62ch] text-[15px] leading-[1.7] text-text-secondary">
            Currently at ConnectiveRx; previously CMU MISM. I work across product and engineering
            surfaces - from shaping the thesis to shipping the workflow that survives real users.
          </p>
        </div>

        <aside className="border-y border-border-hair py-6">
          <dl className="flex flex-col gap-5">
            <MetaPair label="Now">ConnectiveRx · Healthcare AI</MetaPair>
            <MetaPair label="Base">CMU MISM</MetaPair>
            <MetaPair label="Lens">Eval infrastructure for agentic systems.</MetaPair>
